...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://build-it-bigger-155605.appspot.com/_ah/api/";
  ...
  public class FetchJoke extends MyApiRequest<com.example.builditbigger.backend.myApi.model.JokeSource> {
     ...
     */
    protected FetchJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.builditbigger.backend.myApi.model.JokeSource.class);
    }
